...
pub fn scope_for_app(app: &crate::TuiApp) -> InputScope {
    ...
    } else if app.preview_context_menu.active {
        InputScope::PreviewContextMenu
    ...
    BINDINGS
        .get_or_init(|| {
            vec![
                ...
                KeyBinding::single(PreviewContextMenu, Esc, Mods::NONE, Close),
                KeyBinding::single(PreviewContextMenu, Up, Mods::NONE, MoveUp),
                KeyBinding::single(PreviewContextMenu, Char('k'), Mods::NONE, MoveUp),
                KeyBinding::single(PreviewContextMenu, Down, Mods::NONE, MoveDown),
                KeyBinding::single(PreviewContextMenu, Char('j'), Mods::NONE, MoveDown),
                KeyBinding::single(PreviewContextMenu, Enter, Mods::NONE, Confirm),
