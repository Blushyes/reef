...
type SbsDisplayLine = CoreSbsDisplayLine<LineTokens>;
type SbsRow = CoreSbsRow<LineTokens>;
...
fn render_file_header(
    ...
    let path_display = truncate_to_width(&diff.path, path_max);
